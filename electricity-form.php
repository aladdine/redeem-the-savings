...
<div class="jumbotron-electricity-rewards">
      <div class="container">
        <h1>Redeem Your Electricity Savings</h1>
      </div>
 </div>
...
<div class="container electricity-form">
	...
	<div class="row">
		...
		<table class="table">
		  ...
		  <tr>
		  	...
		  	<td> <div id="electricity-savings"></div> </td>
		  </tr>
	...
	<div class="row">	
           <div class="col-md-6">
				...
				<div class="input-group">
				  <span class="input-group-addon" id="basic-addon1">How many hours did you electricity the lawn for achieving these savings?</span>
				...
				<div class="form-group">
				  ...
				  <select class="form-control add_points" id="actions-in-the-property">
				    ...
				    <option value="10">Recycling electricity from the sink</option>
 ...
 $("form#air_tickets_form_2").submit(function(event){
  ...
  $.ajax({
    ...
    success: function (data) {
        ...
        check_bill = bill_content.search("CALIFORNIA AMERICAN ELECTRICITY");
        if (check_bill < 0) {

         $("#this-month-consumption").html("<div class='alert alert-danger' role='alert'>Please upload a valid California American electricity bill.</div>");	

        } else {

        this_month_consumption = bill_content.match(/ gallons\) Total electricity Use Comparison/g);
  ...
  $.ajax({
    ...
    success: function (data) {
        ...
        if (check_bill < 0) {
         ...
         $("#this-month-consumption-2").html("<div class='alert alert-danger' role='alert'>Please upload a valid California American electricity bill.</div>");	
        ...
        savings_percent = Math.floor(savings_gallons / consumption_before * 100); 
         ...
         $("#electricity-savings").html("<p class='output'>Your month to month savings are: " + savings_gallons + " gallons (" + savings_percent + "%)</p>");
                 ...
                 points = savings_percent * 2 + 20;
                       ...
                       award = "number of points too low";
				        ...
				        if (points >= 200) {
				        	...
				        	award = "$100 off your next electricity bill";
